...
API_KEY = '5142443470:AAENhP6UQvikMYchlf0jtw1Z50qCg_kLra4'
    ...
    if num_there(text):
        if isValidPinCode(text):
            ...
            for cowin_obj in cowin_objs:
                message += f""" Place name {cowin_obj.fee_type} {cowin_obj.fee}{cowin_obj.available_capacity_dose1}{cowin_obj.available_capacity_dose2}{cowin_obj.available_capacity}{cowin_obj. minimum_age_limit}{cowin_obj.vaccine}\n \n"""

            update.message.reply_text(f"{message}")
            return
        else:
            update.message.reply_text(f"Not a valid pincode")
            return 
