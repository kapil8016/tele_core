...
def get_cowin_data_by_pincode(pincode):
    try:
        ...
        payload = requests.get(f'https://cdn-api.co-vin.in/api/v2/appointment/sessions/public/findByPin?pincode={pincode}&date={current_date}', auth=('user', 'pass'))
        ...
        for session in sessions.get('sessions'):
            ...
            if session.get('available_capacity')>0:
                CowinData.objects.create(
                    ...
                    minimum_age_limit = session.get('minimum_age_limit'),
